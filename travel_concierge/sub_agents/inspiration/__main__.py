...
from inspiration_agent.agent import (
    create_inspiration_agent,
)
...
def main(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    adk_agent = create_inspiration_agent()
    runner = Runner(
        ...
        memory_service=VertexAiMemoryBankService(
            project="gke10-472611", location="us-central-1"
        ),
    )
    agent_executor = InspirationExecutor(runner, agent_card)
